...
<template>
  <a-layout has-sider style="min-height: 100vh">
    ...
    <MainSidebar
      v-if="!app.isMobile && !isTopBar" ref="mainSidebarRef" @key-change="handleMainMenuKeyChange"
    ...
    <SubSidebar
      ...
      :parent-menu-key="mainMenuRootKey" @mouseenter="cancelRestoreSubMenu" @mouseleave="stopTimeout = false"
    />

    <!-- Right main area. 右侧主体区。 -->
    <a-layout content-class="flex flex-col" theme="light" style="height:100vh;">
      <!-- Top bar area. 头部横栏区。 -->
      <TopBar
